    ...
    const search = async (event: Event) => {
        ...
        try {
            ...
            const response = await fetch(
                `${NRDB_API_URL}/decklists?` + parameters.toString(),
            );
    ...
    <div>
        <div>
            ...
            <select
                name="faction"
                id="faction"
                bind:value={filter.selectedFaction}
            >
        ...
        <div>
            ...
            <select
                name="rotation_id"
                id="rotation_id"
                bind:value={filter.selectedRotation}
            >
        ...
        <div>
            ...
            <select name="is_legal" id="is_legal" bind:value={filter.isLegal}>
                {#each tournament_legality as tournament_legality (tournament_legality.value)}
                    <option value={tournament_legality.value}
                        >{tournament_legality.label}</option
                    >
                {/each}
            </select>
        </div>
